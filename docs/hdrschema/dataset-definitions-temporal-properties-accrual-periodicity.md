...
```txt
http://healthdatagateway.org/schema/dataset.json#/definitions/temporal/properties/accrual-periodicity
```
...
merged type ([Details](dataset-definitions-temporal-properties-accrual-periodicity.md))
